...
var APP_VERSION_INFO = {
    ...
    categories: [
        ...
        {
            title: "Cải Thiện Giao Diện Header Chuẩn Studio Sang Trọng (V16.2)",
            icon: "sparkles",
            color: "text-indigo-400 bg-indigo-500/10 border-indigo-500/30",
            items: [
                "Thiết kế Glassmorphism hiện đại: Thanh Header trong suốt mờ ảo (Backdrop Blur), đổ bóng nổi khối và đường viền tinh tế.",
                "Phân cụm chức năng khoa học: Tách biệt rõ ràng giữa Logo thương hiệu, Bộ điều hướng các bước (Studio Timeline - Cấu trúc Lưới - Render hàng loạt) và Thanh công cụ tiện ích (Undo/Redo, Xuất/Nhập).",
                "Tối ưu tương thích đa thiết bị: Hiển thị thanh thoát, cân đối trên mọi màn hình máy tính và thiết bị di động."
            ]
        },
        {
